...
class LeftButtonsMapFree extends Component {
  constructor(props) {
    super(props);
    this.state = {
      id_figure: ''
  ...
  renderMarker(Id, lat, lng, name,tag) {
  ...
  receivedPlace(Id, lat, lng, name,tag) {
    this.renderMarker(Id, lat, lng, name,tag)
  }
...
export default LeftButtonsMapFree
